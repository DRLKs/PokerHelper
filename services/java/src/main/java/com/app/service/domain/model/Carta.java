package com.app.service.domain.model;
...
public class Carta {
	 ...
	 */
	public static int hay_N_CartasRepetidasMismoNumero( List<Carta> cartas , int n) {
	...
	public static int hay_N_CartasRepetidasMismoNumeroMesa( List<Carta> cartas , int n) {
	 ...
	 */
	public static int vecesQueSeSaleEsteNumero( List<Carta> cartas , int numCarta ) {
